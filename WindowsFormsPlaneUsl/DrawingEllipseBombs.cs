...
namespace WindowsFormsPlaneUsl
{
    public class DrawingEllipseBombs : IDrawingElements
    {
        ...
        private void drawTwoBombs(Graphics g, Color DopColor, float _startPosX, float _startPosY)
        {
            ...
            g.FillEllipse(dopBrush, _startPosX + 40, _startPosY - 20, 16, 8);
            g.FillEllipse(dopBrush, _startPosX + 40, _startPosY + 12, 16, 8);
        }
        ...
        private void drawFourBombs(Graphics g, Color DopColor, float _startPosX, float _startPosY)
        {
            ...
            Brush dopBrush = new SolidBrush(DopColor);
            g.FillEllipse(dopBrush, _startPosX + 48, _startPosY - 30, 16, 8);
            g.FillEllipse(dopBrush, _startPosX + 48, _startPosY + 22, 16, 8);
        }
